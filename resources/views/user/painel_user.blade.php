    ...
    <main class="container pagina-usuarios">
                    ...
                    <tbody>
                        @foreach ($clientes as $cliente)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('cliente.destroy', $cliente->id) }}" method="POST" onsubmit="return confirm('Tem certeza que deseja deletar este cliente?')">
                                        @csrf
                                        @method('DELETE')
        ...
        <div id="usuarios">
            ...
            <table class="table table-striped table-sm">
                <thead>
                    <tr class='align-middle text-nowrap table-dark'>
                        <th>Nome</th>
                        <th>Email</th>
                        <th>Cliente</th>
                        <th>Ramal</th>
